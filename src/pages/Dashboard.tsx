      ...
      {isInjectionDayVisual && (
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          ...
          <div
            ...
            style={{
              background: "radial-gradient(circle, hsl(15, 75%, 75%) 0%, hsl(340, 65%, 62%) 40%, transparent 70%)",
              filter: "blur(30px)",
            }}
          />
          ...
          <div
            ...
            style={{
              background: "radial-gradient(ellipse 70% 50%, hsl(340, 65%, 62%) 0%, transparent 70%)",
              filter: "blur(25px)",
            }}
          />
          ...
          <div
            ...
            style={{
              background: "radial-gradient(circle, hsl(340, 65%, 62%) 0%, transparent 70%)",
              filter: "blur(35px)",
            }}
          />
          {/* Noise texture */}
              ...
              isInjectionDayVisual ? (
                <>
                  ...
                  <button
                    ...
                    className="mt-5 bg-[hsl(25,85%,55%)] text-white px-8 py-3 rounded-full text-sm font-bold shadow-elevated active:scale-95 transition-transform"
                  >
